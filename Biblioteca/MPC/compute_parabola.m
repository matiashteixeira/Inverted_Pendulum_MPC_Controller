...
function sc=compute_parabola(sc_past,param, dados)
...
%--------------------------------------------------------
[sc.Jpbarmin,sc.gpbarmin]=BBS(sc.pbarmin,param, dados);
[sc.Jpc,sc.gpc]=BBS(sc.pc,param, dados);
[sc.Jpbarmax,sc.gpbarmax]=BBS(sc.pbarmax,param, dados);
